...
public abstract class InjectableDialogFragment<View extends IBaseView, Presenter extends IBasePresenter<View>>
     ...
     */
    public <Component extends IMVPComponent<View, Presenter>> InjectableDialogFragment(@NotNull Class<Component> cl) {
