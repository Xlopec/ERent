package com.ua.erent.module.core.mvp.view;
...
import com.ua.erent.module.core.mvp.presenter.IBasePresenter;
...
public class InjectableActivity<View extends IBaseView, Presenter extends IBasePresenter<View>>
     ...
     */
    public <Component extends IMVPComponent<View, ?>> InjectableActivity(final int layoutResId, @NotNull Class<Component> cl) {
